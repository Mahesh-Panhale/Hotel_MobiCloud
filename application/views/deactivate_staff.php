  ...
  <div class="col-md-8 mx-auto grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title mb-4">Deactivate Staff</h4>
        ...
        <form>
          ...
          <div class="form-group mb-3">
            ...
            <select class="form-control">
              ...
              <option>Rahul Patil (Housekeeping)</option>
              <option>Priya Sharma (Reception)</option>
              <option>Amit Deshmukh (Maintenance)</option>
            </select>
          </div>
          ...
          <div class="d-flex justify-content-end">
            ...
            <button type="button" class="btn btn-danger">Update Status</button>
          </div>
